...
class CreatorChatScreen extends ConsumerWidget {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                ...
                trailing: room.unreadCountCreator > 0
                    ? CircleAvatar(
                        radius: 12,
                        backgroundColor: AppTheme.primary,
                        child: Text(room.unreadCountCreator.toString(), style: const TextStyle(color: Colors.white, fontSize: 12)),
                      )
