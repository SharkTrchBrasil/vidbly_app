...
abstract class $FavoriteModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String brandId, String creatorId, DateTime createdAt});
}
...
class _$FavoriteModelImpl implements _FavoriteModel {
  ...
  @override
  String toString() {
    return 'FavoriteModel(id: $id, brandId: $brandId, creatorId: $creatorId, createdAt: $createdAt)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, brandId, creatorId, createdAt);
